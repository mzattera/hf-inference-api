...
public class ImageContentPart extends MessageContentPart {
  ...
  private ImageContentPartAllOfImageUrl imageUrl;
  ...
  public ImageContentPart imageUrl(@javax.annotation.Nonnull ImageContentPartAllOfImageUrl imageUrl) {
   ...
   */
  @javax.annotation.Nonnull
  public ImageContentPartAllOfImageUrl getImageUrl() {
    return imageUrl;
  }

  public void setImageUrl(@javax.annotation.Nonnull ImageContentPartAllOfImageUrl imageUrl) {
    this.imageUrl = imageUrl;
  }

...
public class Function {
  ...
  public Function name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }

  /**
   * The name of the function to cal
   * @return name
   */
  @javax.annotation.Nonnull
  ...
  public Function parameters(@javax.annotation.Nullable Object parameters) {
  ...
  public Function strict(@javax.annotation.Nullable Boolean strict) {
    this.strict = strict;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, parameters, strict, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "description", "parameters", "strict"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Function.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Function is not found in the empty JSON string", Function.openapiRequiredFields.toString()));
        }
      }

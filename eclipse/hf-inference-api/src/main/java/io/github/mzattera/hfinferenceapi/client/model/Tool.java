...
public class Tool {
  ...
  public Tool type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Tool.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Tool is not found in the empty JSON string", Tool.openapiRequiredFields.toString()));
        }
      }
      ...
      switch (discriminatorValue) {
        case "function":
          FunctionTool.validateJsonElement(jsonElement);
          break;
        default:

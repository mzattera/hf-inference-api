...
- API version: 1.0.0
  - Build date: 2025-12-07T10:46:12.612097500+01:00[Europe/Berlin]
...
*DefaultApi* | [**getModels**](docs/DefaultApi.md#getModels) | **POST** /api/models | Retrieves models information using a JSON search payload.
